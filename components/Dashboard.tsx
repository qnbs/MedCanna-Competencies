    ...
    <div className="space-y-8 animate-fade-in">
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            ...
            <div className="h-64 md:h-80 w-full bg-slate-50 rounded-lg flex items-center justify-center border border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {competencies.map((comp) => (
                <button
                  ...
                  className="flex items-start p-4 bg-white border border-slate-200 rounded-lg hover:border-emerald-500 hover:shadow-md transition-all duration-200 text-left group"
                >
                  <div className="mr-3 mt-1 bg-emerald-50 p-2 rounded-full group-hover:bg-emerald-100 transition-colors">
                    {getIcon(comp.id)}
                  </div>
                  <div>
        ...
        <h3 className="text-lg font-bold text-slate-800 mb-4 border-t border-slate-100 pt-6">{t('dashboard.toolsTitle')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           <button 
             onClick={() => onNavigate('simulation')}
             className="flex items-center p-5 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl hover:shadow-md transition-all group"
           >
              ...
              <div className="text-left">
                 ...
                 <p className="text-sm text-slate-600">{t('dashboard.simDesc')}</p>
              </div>
           </button>

           <button 
             onClick={() => onNavigate('pharmacology')}
             className="flex items-center p-5 bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-100 rounded-xl hover:shadow-md transition-all group"
           >
              ...
              <div className="text-left">
                 ...
                 <p className="text-sm text-slate-600">{t('dashboard.pharmDesc')}</p>
              </div>
           </button>
        </div>
      </div>
